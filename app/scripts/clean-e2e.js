...
// Risolviamo il percorso della cartella dati E2E (nella root di OrbitPage)
...
try {
  ...
  fs.writeFileSync(path.join(e2eDataDir, 'orbitpage.db'), '');
  console.log('🛡️  E2E Cleanup: Inizializzato database di test vuoto (0-byte) in:', path.join(e2eDataDir, 'orbitpage.db'));
} catch (err) {
